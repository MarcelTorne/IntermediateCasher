...
export default class SceneInit {
  ...
  render() {
    ...
    postJoin(){
        ...
        // this.transformControls.detach();
        let mesh1, mesh2;
        console.log("mesh 1", this.two_meshes[0])
        console.log("mesh 2", this.two_meshes[1])
        mesh1 = this.csgEvaluator.evaluate( this.two_meshes[0], this.two_meshes[1], ADDITION );
        // debugger
        mesh1.material = this.two_meshes[0].material.clone();
